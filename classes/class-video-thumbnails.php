<?php
if ( ! class_exists( 'Wolf_Portfolio_Video_Thumbnails' ) ) {
	/**
	 * Wolf Portfolio Video Thumbnail
	 *
	 * Generate thumbnail from youtube and vimeo video
	 *
	 * @author WpWolf
	 * @package WolfPortfolio/Classes
	 * @since 1.1.2
	 */
	class Wolf_Portfolio_Video_Thumbnails {

		/**
		 * Wolf_Portfolio_Video_Thumbnails Constructor.
		 *
		 * @access public
		 * @return void
		 */
	...
	$wolf_portfolio_do_video_thumbnails = new Wolf_Portfolio_Video_Thumbnails;
